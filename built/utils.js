...
export function OffData(data) {
    ...
    const offData = {
        ...
        unidadCantidad: product_quantity_unit !== null && product_quantity_unit !== void 0 ? product_quantity_unit : getQuantityUnit(quantity),
        imagenFrontalUrl: image_url,
        nivelesAltos: Object.keys(nutrient_levels !== null && nutrient_levels !== void 0 ? nutrient_levels : {})
